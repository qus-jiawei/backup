...
define("logfile", default='uhpkeeper.log', help="The uvpkeeper log file name", type=str)
define("log_dir", default='/home/hadoop/uhp/log/uvpkeeper', help="The uvpkeeper log dir", type=str)
define("logformatter", default='(%(name)s): %(asctime)s %(levelname)s %(module)s %(funcName)s %(message)s', help="The uvpkeeper log formatter", type=str)

def parse_config_file(conf_file):
    if not conf_file:
        conf_file = "/etc/uhp/uhp_web.conf"
    conf_file_other = "etc/uhp_web.conf"
...
class Application(tornado.web.Application):
    def __init__(self):
        ...
        self.engine = create_engine(options.connection,echo =True)
